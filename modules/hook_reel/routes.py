...
Tres entradas: video 1 (avatar + voz), video 2 (clip de cierre) y música. Flujo
de dos fases cuando hay subtítulos (igual que reel_express):
...
def process():
    ...
    thread = threading.Thread(
        ...
        kwargs=dict(video1_path=video1_path, video2_path=video2_path,
                    music_path=music_path, params=params),
        daemon=True,
    )
    thread.start()
